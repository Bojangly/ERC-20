...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Token";
    string private constant _symbol = unicode"Token";
    ...
    constructor () {
        ...
        // mint entire supply to deployer, add as tax wallet
        _taxWallet = payable(_msgSender());
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;
        // exclude disperse address from taxes
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 taxAmount=0;
        if (to != owner() && !_isExcludedFromFee[from] ) {
    ...
    function addPresaleAddress(address presale) external onlyOwner{
